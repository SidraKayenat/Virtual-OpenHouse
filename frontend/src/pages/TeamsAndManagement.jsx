...
export default function TeamsAndManagement() {
  ...
  // Apply status filter after role filter is applied by API
              ...
              <div className="flex items-center gap-2">
                ...
                <div className="relative" ref={roleDropdownRef}>
                  ...
                  >
                    ...
                    <ChevronDown
                      size={12}
                      className={`transition-transform ${openRoleDropdown ? "rotate-180" : ""}`}
                    />
                  </button>
                    ...
                    {openRoleDropdown && (
                      ...
                      >
                        <button
                          ...
                          className={`w-full flex items-center justify-between px-3 py-2 text-[11px] transition-all ${
                            roleFilter === "all"
