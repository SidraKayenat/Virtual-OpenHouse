...
export default function UserDetails() {
  ...
  // Replace the existing handleActivate and handleDeactivate functions (around line 430-440)
            ...
            <div className="flex items-center gap-2 flex-shrink-0 flex-wrap">
              ...
              {user.isActive ? (
                <button
                  ...
                  disabled={toggling}
                  className="px-4 py-2 rounded-xl text-[11px] font-bold bg-red-500/10 text-red-400 border border-red-500/20 flex items-center gap-1.5 disabled:opacity-50"
                >
                  {toggling ? (
                ...
                <button
                  ...
                  disabled={toggling}
                  className="px-4 py-2 rounded-xl text-[11px] font-bold bg-emerald-500/10 text-emerald-400 border border-emerald-500/20 flex items-center gap-1.5 disabled:opacity-50"
                >
                  {toggling ? (
